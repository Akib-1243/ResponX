  ...
  return (
    ...
    sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
        ...
        text-indigo-300 text-sm '>
          ...
          <p className='text-center text-sm mb-06'>{state==='Sign Up' ? 'Create your account' : 'Login to your account!'}</p>
          ...
          {state==='Sign Up'?(<p className='text-gray-400 text-center text-xs mt-4'>Already have an account?{' '}
            <span onClick={()=> setState('Login')} className='text-blue-400 cursor-pointer underline'>Login
            here</span>
          </p>) :
          
          
          (<p className='text-gray-400 text-center text-xs mt-4'>Don't have an account?{' '}
            <span onClick={()=> setState('Sign Up')} className='text-blue-400 cursor-pointer underline'>Sign
            Up</span>
          </p>)}
